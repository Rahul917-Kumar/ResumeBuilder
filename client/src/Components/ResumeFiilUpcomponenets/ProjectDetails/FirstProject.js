...
function FirstProject({
  ...
  const [project, setProject] = useState({
    link: projectfirst.link,
    title: projectfirst.title,
    firstpoint: projectfirst.description.firstpoint,
    secondpoint: projectfirst.description.secondpoint,
    thirdpoint: projectfirst.description.thirdpoint,
  });
  ...
  const updateData = async (e) => {
    ...
    updateProjects(updatedData, "projectfirst");
